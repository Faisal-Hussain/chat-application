        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8">
                <div class="admin_screen_cont" style="margin-top: 120px;width:100%;margin-left:0px">
                    <h4 class="text-center">Admin profile settings</h4>
                    <hr />
                    <form method="POST" enctype="multipart/form-data" action="{{route('admin_profile_save')}}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nick_name" value="{{Auth::user()->nick_name}}" id="nick_name" class="form-control bg-white">
                        </div>
                        <div class="form-group mt-3">
                            <label class="fs_18 f_400">Username</label>
                            <input type="text" name="username" value="{{Auth::user()->username}}" id="username" class="form-control bg-white">
                        ...
                        <div class="form-group mt-3">
                            <img src="{{Auth::user()->get_avatar()}}" style="width: 48px;height:48px;border-radius:50%"/>
                            <div class="mt-2">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <select name="age" id="age" class="form-select  bg-white  @error('age') is-invalid @enderror">
                                ...
                                @if(count($ages) > 0)
                                    @foreach($ages as $age)
                                        <option value="{{$age}}" @if(Auth::user()->age == $age) selected @endif>{{ $age }}</option>
                                    @endforeach
                                @endif
                            </select>
                        </div>
                        <div class="form-group mt-3">
                            ...
                            <select name="gender" id="gender" class="form-select">
                                ...
                                <option value="2" @if(Auth::user()->gender == 1) selected @endif>Female</option>
                            </select>
                        </div>
