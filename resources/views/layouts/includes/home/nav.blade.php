        ...
        <div class="header_inner d_flex justify_content_space_between align_items_center">
            ...
            <div class=" header_content_b d_flex align_items_center justify_content_space_between">
                ...
                <a href="{{ route('search') }}" class="d_flex align_items_center fs_16 c_white">
                    <p class="fs_16 remove_for_mobile @if(Illuminate\Support\Facades\Route::currentRouteName() == 'search') c_blue @else  c_white @endif">
                        Search
                    </p>
                ...
                <a  href="{{ route('chat.history') }}" class="d_flex align_items_center c_white fs_16">
                    <p class="fs_16 remove_for_mobile @if(Illuminate\Support\Facades\Route::currentRouteName() == 'chat.history') c_blue @else  c_white @endif">
                        Chat History
                    </p>
                ...
                <a  href="{{ route('inbox') }}" class="d_flex align_items_center c_white fs_16">
                    <p class="fs_16 remove_for_mobile @if(Illuminate\Support\Facades\Route::currentRouteName() == 'inbox') c_blue @else  c_white @endif">
                        Inbox
                    </p>
                ...
                <a href="{{ route('logout') }}" class="d_flex align_items_center c_white fs_16" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();">
                    <p class="c_white fs_16 remove_for_mobile">
                        Logout
                    </p>
                    <img src="{{asset('/images/icons/logout.png')}}" style="width:24px;height:24px;margin-left:10px;"/>
                </a>
