                        ...
                        <div class="sign_in_inputs_blocks d_flex fd_column">
                            <form method="POST" action="{{ route('reset.password.post') }}">
                                ...
                                <div class="sign_in_input_b margin_top_24">
                                    <input id="email" type="text" class="form-control bg-white @error('email') is-invalid @enderror"
                                ...
                                <div class="sign_in_input_b margin_top_24">
                                    <input id="password-confirmation" type="password" class="form-control bg-white @error('password_confirmation') is-invalid @enderror"
                                ...
                                <button type="submit" class="bc_darkBlue margin_top_24 c_white chat_btn fs_16">Reset Password</button>
                            </form>
                        </div>
